...
<body>
    ...
    <?php else: ?>
        ...
        <form method="POST">
            ...
            <div>
                <h3>Vos hobbies (vous aimez forcément un de ces trucs là)</h3>
                <input type="checkbox" name="hobbies[]" value="warcraft"> <label>Warcraft</label> <br>
                <input type="checkbox" name="hobbies[]" value="rugby"> <label>Rugby</label> <br>
                <input type="checkbox" name="hobbies[]" value="lecture"> <label>Lecture</label> <br>
                <input type="checkbox" name="hobbies[]" value="jogging"> <label>Jogging</label> <br>
            </div>

            <div>
                <h3> Vos loisirs </h3>
                <select multiple name="loisirs[]">
